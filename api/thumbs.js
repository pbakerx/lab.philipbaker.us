...
- Keys: F forward, V back, D and G turn, J and L side-step, A about-face, K or Space fires; the arrow keys work too. Return opens the message box. On a phone: a joystick under the left thumb (push the way you want to go, as on the map: up is north), two TURN buttons above it to turn in place, FIRE under the right thumb, and the envelope sends a message.
...
- The Robot menu has a robot sidekick. File menu: Invite a Friend (it shows a link to copy and send; whoever opens it lands in this same maze — and when a real person arrives, you leave), High Scores, My Card, and Wait in the Lobby — out of the maze, where nothing can reach you (any form, like Suggest a Feature, takes you there by itself while it is open; the obituary has a Lobby button too). Options menu: Phone opens a private line, for a game among friends. Apple menu: Suggest a Feature (ideas are public; Everyone's Ideas shows the list), and Where It Came From, the story of the people who made Maze.
