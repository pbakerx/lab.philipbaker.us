  ...
  for (const spec of AD.els) {
    ...
    if (spec.type === 'img') {
      ...
      if (spec.fit === 'contain' || spec.fit === 'cover') {
        ...
        if (spec.radius) wrap.style.borderRadius = px(spec.radius);
      ...
      if (spec.clipTo) {
        ...
        if (spec.clipRadius) cw.style.borderRadius = px(spec.clipRadius);
      ...
      if (spec.radius) el.style.borderRadius = px(spec.radius);
